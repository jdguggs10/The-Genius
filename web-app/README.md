...
```
web-app/
├── public/                      # Static files (icons, PWA manifest assets, etc.)
...
│   ├── types/index.ts           # TypeScript type definitions (including SSEEventData for WS)
│   └── index.css                # Global styles, Tailwind imports, dark mode base styles
├── package.json                 # Lists all dependencies and scripts
├── vite.config.ts               # Vite configuration (including VitePWA plugin)
├── tailwind.config.js           # Tailwind CSS configuration (darkMode: 'class' enabled)
